document.addEventListener("DOMContentLoaded", (event) => {
  ...
  ScrollTrigger.matchMedia({
    "(min-width: 769px)": function () {
      ...
      const hero_buttons = gsap.utils.toArray(".hero-text-container .custom-button-container .custom-button");
      ...
      const footer_buttons = gsap.utils.toArray(".footer-banner .custom-button-container .custom-button");
      ...
      const dtc_text = gsap.utils.toArray(".default-text-col2 .elementor-widget-container p");
